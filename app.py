...
st.sidebar.caption("Global Catalog Insights & Strategy")
st.sidebar.markdown("---")
...
st.caption(
    "Interactive intelligence platform summarizing catalog macro trends, "
    "content distributions, and detailed title exploration."
)
st.markdown("---")
